...
class AllInfoEventActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val allInfoEventNameTextView: TextView = findViewById<TextView>(R.id.allInfoEventName) as TextView
        ...
        val allInfoStartTextView: TextView = findViewById<TextView>(R.id.allInfoStart) as TextView
        allInfoStartTextView.text = allInfoStart

        val allInfoEnd =this.intent.getStringExtra("allInfoEnd")
        val allInfoEndTextView: TextView = findViewById<TextView>(R.id.allInfoEnd) as TextView
        allInfoEndTextView.text = allInfoEnd

        val allInfoDescription =this.intent.getStringExtra("allInfoDescription")
        val allInfoDescriptionTextView: TextView = findViewById<TextView>(R.id.allInfoDescription) as TextView
        allInfoDescriptionTextView.text = allInfoDescription

        val allInfoEventType =this.intent.getStringExtra("allInfoEventType")
        val allInfoEventTypeTextView: TextView = findViewById<TextView>(R.id.allInfoEventType) as TextView
        allInfoEventTypeTextView.text = allInfoEventType

        val allInfoPeopleNeeded =this.intent.getStringExtra("allInfoPeopleNeeded")
        val allInfoPeopleNeededTextView: TextView = findViewById<TextView>(R.id.allInfoPeopleNeeded) as TextView
